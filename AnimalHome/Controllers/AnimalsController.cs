...
public class AnimalsController: Controller
{
    ...
    public async Task<ActionResult> UpdateAnimal(Guid id, UpdateAnimalDto updateAnimalDto)
    {
        ...
        animal.Status = updateAnimalDto.Status != null ? 
            EnumHelper.EnumParse(updateAnimalDto.Status, animal.Status) : animal.Status;
        ...
        animal.CoverImageUrl = updateAnimalDto.CoverImageUrl ?? animal.CoverImageUrl;
        animal.Weight = updateAnimalDto.Weight ?? animal.Weight;
        animal.Age = updateAnimalDto.Age ?? animal.Age;
